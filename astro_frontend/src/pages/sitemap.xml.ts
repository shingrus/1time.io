...
const coreRoutes: RouteEntry[] = [
    ...
    {path: '/about/', priority: 0.5, changefreq: 'monthly', lastmod: '2026-03-23'},
    {path: '/privacy/', priority: 0.4, changefreq: 'monthly', lastmod: '2026-03-22'},
];

const blogRoutes: RouteEntry[] = [
    {path: '/blog/', priority: 0.7, changefreq: 'daily', lastmod: '2026-04-04'},
    {path: '/blog/firefox-send-alternative/', priority: 0.6, changefreq: 'monthly', lastmod: '2026-04-04'},
    ...
    {path: '/blog/hkdf-key-derivation-explained/', priority: 0.6, changefreq: 'monthly', lastmod: '2026-03-21'},
    {path: '/blog/password-for-crypto-wallet/', priority: 0.6, changefreq: 'monthly', lastmod: '2026-03-21'},
    {path: '/blog/bitwarden-send-alternative/', priority: 0.6, changefreq: 'monthly', lastmod: '2026-03-21'},
    ...
    {path: '/blog/password-pusher-alternative/', priority: 0.6, changefreq: 'monthly', lastmod: '2026-03-20'},
