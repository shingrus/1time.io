...
export const PRESETS: Record<string, GeneratorPreset> = {
    ...
    '/passphrase-generator': {
        ...
        meta: {
            ...
            ogTitle: 'Passphrase Generator — Memorable & Secure Multi-Word Passwords',
            ogDescription: 'Generate memorable multi-word passphrases that are easy to type and hard to crack. Uses cryptographic randomness.',
