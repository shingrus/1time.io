...
export const PRESETS: Record<string, GeneratorPreset> = {
    ...
    '/password-generator-15-characters': {
        ...
        meta: {
            ...
            ogDescription: 'Generate a strong 15-character password with letters, numbers, and symbols. Meets enterprise and compliance requirements.',
