...
export const blogPosts: BlogPost[] = [
    {
        ...
        "ogTitle": "Bitwarden Send Alternative — Free, No Account Required",
        "ogDescription": "Need to share a secret without a Bitwarden account? Use zero-knowledge one-time links for encrypted password and file sharing.",
    ...
    },
    {
        ...
        "ogTitle": "Best Firefox Send Alternative — Free & Self-Hostable",
        "ogDescription": "Firefox Send is gone. Share encrypted files with zero-knowledge one-time links. Free, open source, no signup, and self-hostable.",
    ...
    },
    {
        ...
        "ogTitle": "What Is HKDF and Why We Use It for End-to-End Encryption",
        "ogDescription": "How 1time.io uses HKDF to derive separate encryption and authentication keys from one master secret.",
    ...
    },
    {
        ...
        "ogTitle": "Password Pusher Alternative — Zero-Knowledge & Free",
        "ogDescription": "Compare Password Pusher with 1time.io. Share passwords using browser-side encryption, one-time links, no signup, and open-source code.",
